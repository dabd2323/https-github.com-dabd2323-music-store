      ...
      <Dialog open={editProductModal} onOpenChange={setEditProductModal}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleEditProduct} className="space-y-4">
            ...
            <div>
              <Label>URL Audio Preview</Label>
              <Input value={productForm.audio_preview_url} onChange={(e) => setProductForm({...productForm, audio_preview_url: e.target.value})} />
            </div>
            <div>
              <Label>URL Fichier Audio</Label>
              <Input value={productForm.audio_file_url} onChange={(e) => setProductForm({...productForm, audio_file_url: e.target.value})} />
            </div>
            <div>
              <Label>Description</Label>
            ...
            <DialogFooter>
              <Button type="button" variant="outline" onClick={() => setEditProductModal(false)}>Annuler</Button>
